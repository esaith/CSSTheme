    ...
    function mainController($scope) {
        ...
        $scope.submit = function () {
            $scope.$evalAsync(function () {
                chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
                    chrome.tabs.sendMessage(tabs[0].id, { EVENT: EVENTS.ALL, VALUE: $scope.categories }, function (response) { });
                });
        ...
        $scope.reset = function () {
            colors = JSON.parse(JSON.stringify(backupOriginalColors));
        };
        ...
        const treasureMap = {
            ...
            properties: [
                {
                    Name: 'Treasure Map Button Open Background Color', Property: 'treasureMapBtnOpen-backgroundColor'
                },
                {
                    Name: 'Treasure Map Button Close', Property: 'treasureMapBtnClose-backgroundColor'
                },
                {
                ...
                {
                    Name: 'Left Bar Open Color', Property: 'leftBarOpen-color'
                },
                {
                    Name: 'Left Bar Open Background Colors', Property: 'leftBarOpen-backgroundColor'
                },
                {
                    Name: 'Left Bar Open Small Item Background Color', Property: 'leftBarOpenMiniPage-backgroundColor'
                },
                {
                ...
                {
                    Name: 'Left Bar Open Registration Button Icon BackgroundColor', Property: 'registrationIcon-backgroundColor'
                },
                {
        ...
        const globalHud = {
            ...
            properties: [
                {
                    Name: 'Global Hud Closed Background Color', Property: 'globalHudClosed-backgroundColor'
                },
                {
                    Name: 'Global Hud Open Background Color', Property: 'globalHudOpen-backgroundColor'
                },
                {
                    Name: 'Global Hud Closed Icon Background Color', Property: 'globalHudClosedIcon-backgroundColor'
                },
                {
                    Name: 'Global Hud Open Pie Slice Background Color', Property: 'globalHudOpenPieSlice-backgroundColor'
                }
            ]
        };
