var ColorTheme = (function() {
  ...
  const baseColors = {
    ...
    filterMenuFloorplans: {
      ...
      "filterslider-floorplans-header-borderBottomColor": "", //mainColors.minorcolor3,
      "filterslider-floorplans-neighborhood-color": "", //mainColors.contentColor,
      "filterslider-floorplans-neighborhood-backgroundColor": "", //mainColors.majorcolor2,
      "filterslider-floorplans-neighborhood-option-color": "", //mainColors.minorcolor1,
      "filterslider-floorplans-neighborhood-option-backgroundColor": "", //mainColors.majorcolor1,
      "filterslider-floorplans-neighborhood-selected-color": "" //mainColors.contentColor
    },
    dropDownColor: {
    ...
    energyEfficiency: {
      ...
      "energyEfficiency-hotspot-pulse-backgroundColor": "", //mainColors.highlightColor2,
      ...
      "energyEfficiency-sideMenu-categoryIndex-backgroundColor": "", //mainColors.minorcolor1,
      "energyEfficiency-sideMenu-categoryIndex-color-selected": "", //mainColors.contentColor,
      "energyEfficiency-sideMenu-categoryIndex-backgroundColor-selected": "", //mainColors.highlightColor1,
      "energyEfficiency-sideMenu-content-color": "", //mainColors.detailColor4,
      "energyEfficiency-sideMenu-content-backgroundColor": "" //mainColors.majorcolor1
    },
    locationColors: {
      ...
      "location-markerInfo-favButton-tail-backgroundColor": "", // '', //mainColors.detailcolor3,
      ...
      "location-addMarkerForm-submitBtn-backgroundColor": "", //mainColors.highlightColor2,
    ...
    furniture: {
      ...
      "furnitureMenu-category-content-popout-backgroundColor": "", // '', //mainColors.majorcolor1,
      "furnitureMenu-category-content-popout-arrow-color": "", //mainColors.majorcolor1,
      "furnitureMenu-category-content-popout-borderColor": "" //mainColors.minorcolor2
    },
    lotmap: {
    ...
    brochureColors: {
      ...
      "brochure-cardRow-elevation-info-backgroundColor": "", //mainColors.detailcolor4,
    ...
    for (const categoryId in colors) {
      for (const propertyId in colors[categoryId]) {
        ...
        if (ele) {
          ...
          if (hex && hex.length > 1 && hex[0] !== "#") hex = "#" + hex;
          ...
          if (hex) {
            ...
            ele.value = "";
            ele.style.backgroundColor = "rbg(0,0,0,0)";
            colors[categoryId][propertyId] = "";
          }
        }
      }
    }
  ...
  function loadColors() {
    for (const categoryId in colors) {
      for (const propertyId in colors[categoryId]) {
        let hex = colors[categoryId][propertyId];
        const ele = document.getElementById(propertyId);

        if (ele) {
          if (colors[categoryId][propertyId]) {
            if (colors[categoryId][propertyId][0] !== "#") {
              colors[categoryId][propertyId] =
                "#" + colors[categoryId][propertyId];
            }

            ele.value = colors[categoryId][propertyId];
            ele.style.backgroundColor = colors[categoryId][propertyId];
          } else {
            ele.value = "";
            ele.style.backgroundColor = "rbg(0,0,0,0)";
            colors[categoryId][propertyId] = "";
